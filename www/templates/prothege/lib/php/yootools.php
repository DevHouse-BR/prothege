	...
	function addCSS(&$document) {
		...
		if ($this->getParam('gzip')) {
			...
			if ($color != '' && $color != 'default') {
				...
				$document->addStyleSheet($baseurl.'/css/'.$color.'/'.$color.'-typography.css');
				$document->addStyleSheet($baseurl.'/css/'.$color.'/'.$color.'-menus.css');
				$document->addStyleSheet($baseurl.'/css/'.$color.'/'.$color.'-modules.css');
				$document->addStyleSheet($baseurl.'/css/'.$color.'/'.$color.'-joomla.css');
				$document->addStyleSheet($baseurl.'/css/'.$color.'/'.$color.'-extensions.css');
			}
			if ($this->isIe(7)) {
