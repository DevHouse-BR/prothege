...
function modChrome_yoo($module, &$params, &$attribs) {
	...
	if ($suffix == '') {
		if ($module->position == 'header') $suffix = 'rounded';
		if ($module->position == 'top') $suffix = 'rounded';
		if (($module->position == 'top-equal') || ($module->position == 'top-goldenratio')) $suffix = 'rounded';
		if ($module->position == 'left') $suffix = 'rounded';
		if ($module->position == 'right') $suffix = 'line';
		if (($module->position == 'main-top-equal') || ($module->position == 'main-top-goldenratio')) $suffix = 'rounded';
		if (($module->position == 'content-top-equal') || ($module->position == 'content-top-goldenratio')) $suffix = 'concave';
		if (($module->position == 'content-bottom-equal') || ($module->position == 'content-bottom-goldenratio')) $suffix = 'concave';
		if (($module->position == 'main-bottom-equal') || ($module->position == 'main-bottom-goldenratio')) $suffix = 'grey';
		if (($module->position == 'bottom-equal') || ($module->position == 'bottom-goldenratio')) $suffix = 'separator';
		if ($module->position == 'bottom') $suffix = 'rounded';
	}

	// force module type
	if ($module->position == 'toolbar')  $suffix = 'blank';
	if ($module->position == 'header')  $suffix = 'rounded-header';
	...
	switch ($skeleton) {
		case '3n-3n-3n':
			 ...
			 */
			?>
			<div class="<?php echo $suffix; ?> <?php echo $color; ?>">
				<div class="module">
		...
		case '3n-2n-3n':
			/*
			 * module skeleton with 3n-2n-3n div structure 
			 * usage: concave
			 *
			 * 3n: 3 nested divs
			 */
